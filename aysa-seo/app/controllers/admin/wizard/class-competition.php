...
class Competition implements Wizard_Step
{
    private $view;
    ...
    {
        $this->view->admin_wizard_competition_page(
            [
                'page_title' => 'Competition',
                'settings' => $this->wizardModel->get_settings_class(Settings::COMPETITION_SETTINGS_NAME)
            ]
        );
    }
    ...
    {
        $this->wizardModel->save($values, Settings::COMPETITION_SETTINGS_NAME);
    }
}