<?php
use Aysa\Includes\i18n;
use Aysa\Includes\Dependency_Loader;
use Aysa\Core\Registry\Controller as Controller_Registry;
use Aysa\Core\Registry\Controller as Model_Registry;
use Aysa\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'Aysa' ) ) {
	 ...
	 */
	class Aysa extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Aysa    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Aysa::PLUGIN_ID );
