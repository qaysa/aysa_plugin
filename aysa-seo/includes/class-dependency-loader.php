...
if ( ! class_exists( 'Dependency_Loader' ) ) {
	...
	class Dependency_Loader {
		...
		public function load_dependencies( $class ) {
			...
			$file_path = Aysa::get_plugin_path() . implode( '/', $parts ) . $class_file_name;
			...
			$file_path = Aysa::get_plugin_path() . implode( '/', $parts ) . $trait_file_name;
		...
		protected function load_registries() {
			require_once( Aysa::get_plugin_path() . 'core/registry/trait-base-registry.php' );
			require_once( Aysa::get_plugin_path() . 'core/registry/class-controller.php' );
			require_once( Aysa::get_plugin_path() . 'core/registry/class-model.php' );
		}
		...
		protected function load_core() {
			...
			foreach ( glob( Aysa::get_plugin_path() . 'core/*.php' ) as $path ) {
				require_once $path;
			}
		}
		...
		protected function autoload_dependencies() {
            ...
            require_once( Aysa::get_plugin_path() . 'vendor/action-scheduler/action-scheduler.php' );
		}
	}
